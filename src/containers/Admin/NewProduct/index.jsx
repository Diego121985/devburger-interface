...
import { Container, Input, InputGroup, Select, LabelUpload, Label, Form, SubmitButton, ErrorMessage } from "./styles";
...
const schema = yup.object({
    ...
    file: yup.mixed()
        ...
        .test('fileSize', 'Carregue arquivos até 8mb', (value) => {
            return value && value.length > 0 && value[0].size <= 80000;
